...
if __name__ == '__main__':
    ...
    text = '''Вопрос: Какие условия являются обязательными для получения 33 услуги?  Ответ: ребенок - гражданин РФ, имеющий место жительства (постоянную регистрацию) в СПб И один из родителей (усыновителей) или оба родителя (усыновителя) - граждане РФ, имеющие место жительства (постоянную регистрацию) в СПб; Мать - встала на медицинский учет по поводу беременности в учреждении здравоохранения в срок до 20 недель (включительно) ИЛИ ребенка усыновили в возрасте до шести месяцев; Обращение последовало не позднее полутора лет со дня рождения ребенка. Название услуги: Предоставлять дополнительную меру социальной поддержки в виде единовременной компенсационной выплаты при рождении ребенка (усыновлении в возрасте до шести месяцев) для приобретения предметов детского ассортимента и продуктов детского питания.'''
